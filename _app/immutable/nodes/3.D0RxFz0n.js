...
`+Object.entries(this._comment).map(([t,e])=>`    ${t}: ${e}`).join(`
`):"")+`
]`}}function jt(s){const t=new ct({iri:s["@id"],label:s.label,comment:s.comment}),e={};let i=F(s.property,vt,e);if(i&&t.setProperty(i),i=F(s.statisticalModifier,R,e),i&&t.setStatisticalModifier(i),i=F(s.ooi,R,e),i&&t.setObjectOfInterest(i),i=F(s.matrix,R,e),i&&t.setMatrix(i),s.context)for(const r of s.context)i=F(r,R,e),t.addContextObject(i);if(s.constraint)for(const r of s.constraint){let{constraint:c,entities:a}=yt(r);a=a.map(f=>e[f]),t.addConstraint(c,...a)}return t}function F(s,t,e){if(!s)return;const i=new t({iri:s["@id"],label:s.label,comment:s.comment,isBlank:!("@id"in s)||s["@id"].startsWith("_:")});e[s["@id"]]=i;for(const r of Z)if(r in s){const c=Array.isArray(s[r])?s[r].map(a=>F(a,t,e)):[F(s[r],t,e)];for(const a of c)i.addComponent(r,a),e[a.getIri()]=a}return i}function yt(s){if(s)return{constraint:new ht({iri:s["@id"],label:s.label,comment:s.comment}),entities:s.constrains}}var Ct=C('<a class="navBoxItem"><li> </li></a>'),xt=C('<ul class="svelte-10b7788"></ul>'),Ot=C('<li class="navBoxSection svelte-10b7788"><label class="svelte-10b7788"><i> </i></label> <input type="checkbox" class="svelte-10b7788"/> <ul class="varlist svelte-10b7788"></ul> <!></li>'),St=st(C(`<div class="navBox svelte-10b7788"><div class="navBoxHead">Filter</div> <div class="navBoxBody filterBody svelte-10b7788"><input type="text" id="filter" placeholder="Filter Variables ..." class="svelte-10b7788"/> <script>
      (function(){
    ...
    <\/script></div></div> <div class="navBox menu svelte-10b7788"><div class="navBoxHead">Navigation</div> <div class="navBoxBody svelte-10b7788" style="overflow-y: auto;"><ul class="svelte-10b7788"></ul></div></div>`,1));function wt(s,t){rt(t,!0);const e=(j,g=at)=>{var M=Ot(),x=l(M),D=l(x),G=l(D,!0);o(D),o(x);var L=h(x,2);ut(L);var v=h(L,2);H(v,21,()=>g().variables,m=>m.path,(m,u)=>{var p=Ct(),w=l(p);let P;var A=l(w,!0);o(w),o(p),k(()=>{z(p,"href",(n(i)?`${n(i)}/${n(u).path}`:n(u).path)+".html"),P=gt(w,1,"svelte-10b7788",null,P,{selected:t.selected==n(u).path}),B(A,n(u).title)}),b(m,p)}),o(v);var d=h(v,2);{var O=m=>{var u=xt();H(u,21,()=>Object.values(g().children),p=>p.id,(p,w)=>{e(p,()=>n(w))}),o(u),b(m,u)};V(d,m=>{Object.values(g().children).length&&m(O)})}o(M),k(m=>{z(x,"for",`checkBox${g().id??""}`),B(G,g().label),z(L,"id",`checkBox${g().id??""}`),_t(L,m)},[()=>n(r).has(g().id)]),b(j,M)},i=T(()=>t.selected.split("/").slice(0,-1).map(()=>"..").join("/")),r=T(()=>{const j=new Set,g=t.selected.split("/");let M=t.variables;for(const x of g)x in M.children&&(M=M.children[x],j.add(M.id));return j});var c=St(),a=h(J(c),2),f=h(l(a),2),I=l(f);H(I,21,()=>Object.values(t.variables.children),j=>j.id,(j,g)=>{e(j,()=>n(g))}),o(I),o(f),o(a),b(s,c),nt()}const W=(s,t=at)=>{var e=Q(),i=J(e);{var r=c=>{var a=Lt(),f=l(a);{var I=v=>{var d=Et(),O=l(d,!0);o(d),k((m,u)=>{z(d,"href",m),B(O,u)},[()=>t().getIri(),()=>t().getLabel(!1)]),b(v,d)},j=v=>{var d=tt();k(O=>B(d,O),[()=>t().getLabel()??t().getShortIri()]),b(v,d)};V(f,v=>{t().getIri()?v(I):v(j,!1)})}var g=h(f,2);{var M=v=>{var d=It(),O=l(d,!0);o(d),k(m=>B(O,m),[()=>t().getComment()]),b(v,d)};V(g,v=>{t().getComment()&&v(M)})}var x=h(g,2);{var D=v=>{var d=Bt(),O=h(l(d),2);H(O,21,()=>t().getConstraints(),m=>m.getIri(),(m,u)=>{var p=kt(),w=l(p);{var P=S=>{var y=tt();k($=>B(y,$),[()=>n(u).getLabel()]),b(S,y)},A=S=>{var y=Mt(),$=l(y,!0);o(y),k((X,_)=>{z(y,"href",X),B($,_)},[()=>n(u).getIri(),()=>n(u).getLabel()]),b(S,y)};V(w,S=>{n(u).isBlank()?S(P):S(A,!1)})}var N=h(w,2);{var U=S=>{var y=Vt(),$=l(y,!0);o(y),k(X=>B($,X),[()=>n(u).getComment()]),b(S,y)};V(N,S=>{n(u).getComment()&&S(U)})}o(p),b(m,p)}),o(O),o(d),b(v,d)};V(x,v=>{t().getConstraints().length>0&&v(D)})}var G=h(x,2);{var L=v=>{var d=Q(),O=J(d);H(O,17,()=>Object.entries(t().getComponents()),([m,u])=>m,(m,u)=>{var p=T(()=>dt(n(u),2));let w=()=>n(p)[0],P=()=>n(p)[1];var A=Rt(),N=l(A),U=l(N,!0);o(N);var S=h(N,2);H(S,17,P,y=>y.getIri(),(y,$)=>{W(y,()=>n($))}),o(A),k(()=>B(U,w())),b(m,A)}),b(v,d)};V(G,v=>{t().getComponentCount()>0&&v(L)})}o(a),b(c,a)};V(i,c=>{t()&&c(r)})}b(s,e)};var Et=C("<a> </a>"),It=C('<p class="desc svelte-iaj60x"> </p>'),Mt=C("<a> </a>"),Vt=C('<p class="description"> </p>'),kt=C('<li class="constraint-item"><!> <!></li>'),Bt=C('<div><span class="subheading">Constraint(s)</span> <ul class="constraint-list"></ul></div>'),Rt=C('<dl class="svelte-iaj60x"><dt class="subheading svelte-iaj60x"> </dt> <!></dl>'),Lt=C("<dd><!> <!> <!> <!></dd>"),$t=C('<a target="_blank" aria-label="Discuss on Github" class="svelte-iaj60x"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 367.4 90" style="height: 1em;"><g fill="currentColor"><path d="m46.1 0c-25.5 0-46.1 20.6-46.1 46.1 0 20.4 13.2 37.7 31.5 43.8 2.3.4 3.2-1 3.2-2.2 0-1.1-.1-4.7-.1-8.6-11.6 2.1-14.6-2.8-15.5-5.4-.5-1.3-2.8-5.4-4.7-6.5-1.6-.9-3.9-3-.1-3.1 3.6-.1 6.2 3.3 7.1 4.7 4.2 7 10.8 5 13.4 3.8.4-3 1.6-5 2.9-6.2-10.3-1.2-21-5.1-21-22.8 0-5 1.8-9.2 4.7-12.4-.5-1.2-2.1-5.9.5-12.2 0 0 3.9-1.2 12.7 4.7 3.7-1 7.6-1.6 11.5-1.6s7.8.5 11.5 1.6c8.8-6 12.7-4.7 12.7-4.7 2.5 6.3.9 11.1.5 12.2 2.9 3.2 4.7 7.3 4.7 12.4 0 17.7-10.8 21.6-21.1 22.8 1.7 1.4 3.1 4.2 3.1 8.5 0 6.2-.1 11.1-.1 12.7 0 1.2.9 2.7 3.2 2.2 18.2-6.1 31.4-23.4 31.4-43.8.3-25.4-20.4-46-45.9-46z"></path><path d="m221.6 67.1h-.1zm0 0c-.5 0-1.8.3-3.2.3-4.4 0-5.9-2-5.9-4.6v-17.5h8.9c.5 0 .9-.4.9-1.1v-9.5c0-.5-.4-.9-.9-.9h-8.9v-11.7c0-.4-.3-.7-.8-.7h-12c-.5 0-.8.3-.8.7v12.1s-6.1 1.5-6.5 1.6-.7.5-.7.9v7.6c0 .6.4 1.1.9 1.1h6.2v18.3c0 13.6 9.5 15 16 15 3 0 6.5-.9 7.1-1.2.3-.1.5-.5.5-.9v-8.4c.1-.6-.3-1-.8-1.1zm132.2-12.2c0-10.1-4.1-11.4-8.4-11-3.3.2-6 1.9-6 1.9v19.6s2.7 1.9 6.8 2c5.8.2 7.6-1.9 7.6-12.5zm13.6-.9c0 19.1-6.2 24.6-17 24.6-9.1 0-14.1-4.6-14.1-4.6s-.2 2.6-.5 2.9c-.2.3-.4.4-.8.4h-8.3c-.6 0-1.1-.4-1.1-.9l.1-62c0-.5.4-.9.9-.9h11.9c.5 0 .9.4.9.9l-.1 20.9s4.6-3 11.3-3h.1c6.8-0 16.7 2.5 16.7 21.7zm-48.7-20.2h-11.7c-.6 0-.9.4-.9 1.1v30.3s-3.1 2.2-7.3 2.2-5.4-1.9-5.4-6.1v-26.5c0-.5-.4-.9-.9-.9h-11.9c-.5 0-.9.4-.9.9v28.5c0 12.3 6.9 15.3 16.3 15.3 7.8 0 14.1-4.3 14.1-4.3s.3 2.2.4 2.5.5.5.9.5h7.5c.6 0 .9-.4.9-.9l.1-41.7c-.1-.4-.6-.9-1.2-.9zm-132.2 0h-11.9c-.5 0-.9.5-.9 1.1v40.9c0 1.1.7 1.5 1.7 1.5h10.7c1.1 0 1.4-.5 1.4-1.5v-41.1c0-.5-.5-.9-1-.9zm-5.8-18.9c-4.3 0-7.7 3.4-7.7 7.7s3.4 7.7 7.7 7.7c4.2 0 7.6-3.4 7.6-7.7s-3.4-7.7-7.6-7.7zm92-1.4h-11.8c-.5 0-.9.4-.9.9v22.8h-18.5v-22.7c0-.5-.4-.9-.9-.9h-11.9c-.5 0-.9.4-.9.9v62c0 .5.5.9.9.9h11.9c.5 0 .9-.4.9-.9v-26.6h18.5l-.1 26.5c0 .5.4.9.9.9h11.9c.5 0 .9-.4.9-.9v-62c0-.4-.4-.9-.9-.9zm-105.3 27.5v32c0 .2-.1.6-.3.7 0 0-7 5-18.5 5-13.9 0-30.3-4.4-30.3-33 0-28.7 14.4-34.6 28.4-34.5 12.2 0 17.1 2.7 17.8 3.2.2.3.3.5.3.8l-2.3 9.9c0 .5-.5 1.1-1.1.9-2-.6-5-1.8-12.1-1.8-8.2 0-17 2.3-17 20.8s8.4 20.6 14.4 20.6c5.1 0 7-.6 7-.6v-12.8h-8.2c-.6 0-1.1-.4-1.1-.9v-10.3c0-.5.4-.9 1.1-.9h20.9c.6-.1 1 .4 1 .9z"></path></g></svg></a>'),Pt=C('<dt class="svelte-iaj60x">Statistical Modifier</dt> <!>',1),At=C('<dt class="svelte-iaj60x">Matrix</dt> <!>',1),Tt=C('<dt class="svelte-iaj60x">Context Objects</dt> <!>',1),zt=st(C(`<nav><!></nav> <main class="svelte-iaj60x"><div class="svelte-iaj60x"><section class="svelte-iaj60x"><h2 class="svelte-iaj60x"> </h2> <p class="links svelte-iaj60x"><!> <a target="_blank" aria-label="Download RDF" class="svelte-iaj60x"><img style="height: 1em;" alt="Download RDF"/></a></p> <p class="description"> </p></section> <section class="textual svelte-iaj60x"><dl class="svelte-iaj60x"><dt class="svelte-iaj60x">Property</dt> <!> <dt class="svelte-iaj60x">Object of Interest</dt> <!> <!> <!> <!></dl></section></div> <br/> <div class="vis svelte-iaj60x"><iframe title="Visualization of the Variable" class="svelte-iaj60x"></iframe> <script>
